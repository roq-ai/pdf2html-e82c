...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Pdf', path: '/pdfs', entity: 'pdf', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Scroll Setting',
      path: '/scroll-settings',
      entity: 'scroll_setting',
      service: AccessServiceEnum.PROJECT,
      icon: FiSettings,
    },
    { name: 'Web Page', path: '/web-pages', entity: 'web_page', service: AccessServiceEnum.PROJECT, icon: FiChrome },
